		...
		if (plugin.getGame().isStarted() == false) {
			...
			if (args.length == 1 || args.length > 2) {
				player.sendMessage(Battle.prefix()
						+ "Correct usage: /battle join <teamname>");
				return true;
			}
			...
			if (args[1].equalsIgnoreCase("green")) {
				...
				player.setDisplayName(ChatColor.DARK_GREEN + "[Battle]"
						+ ChatColor.WHITE + " - " + player.getName());
				player.sendMessage(Battle.prefix()
						+ "You have joined the green team");
				return true;
			}
			if (args[1].equalsIgnoreCase("yellow")) {
				...
				player.setDisplayName(ChatColor.YELLOW + "[Battle]"
						+ ChatColor.WHITE + " - " + player.getName());
				player.sendMessage(Battle.prefix()
						+ "You have joined the yellow team");
				return true;
			}
			if (args[1].equalsIgnoreCase("purple")) {
				...
				player.setDisplayName(ChatColor.DARK_PURPLE + "[Battle]"
						+ ChatColor.WHITE + " - " + player.getName());
				player.sendMessage(Battle.prefix()
						+ "You have joined the purple team");
				return true;
			}
			...
			if (args[1].equalsIgnoreCase("black")) {
				...
				player.setDisplayName(ChatColor.BLACK + "[Battle]"
						+ ChatColor.WHITE + " - " + player.getName());
				player.sendMessage(Battle.prefix()
						+ "You have joined the black team");
				return true;
			}
			...
			if (args[1].equalsIgnoreCase("white")) {
				...
				player.setDisplayName(ChatColor.BOLD + "[Battle]"
						+ ChatColor.WHITE + " - " + player.getName());
				player.sendMessage(Battle.prefix()
						+ "You have joined the white team");
				return true;
			}
