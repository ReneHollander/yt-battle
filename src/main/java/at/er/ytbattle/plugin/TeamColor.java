...
public enum TeamColor {
    ...
    WHITE(ChatColor.WHITE, DyeColor.WHITE, "white", "White"), YELLOW(ChatColor.YELLOW, DyeColor.YELLOW, "yellow", "Yellow"), GREEN(ChatColor.GREEN, DyeColor.LIME, "green", "Green"), CYAN(ChatColor.AQUA, DyeColor.CYAN, "cyan", "Cyan"), PURPLE(ChatColor.DARK_PURPLE, DyeColor.PURPLE, "purple",
            "Purple"), BLUE(ChatColor.DARK_BLUE, DyeColor.BLUE, "blue", "Blue"), RED(ChatColor.RED, DyeColor.RED, "red", "Red"), BLACK(ChatColor.BLACK, DyeColor.BLACK, "black", "Black");
